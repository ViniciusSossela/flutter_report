...
class PaginatedTableReportWidget<K> extends StatefulWidget {
  ...
  const PaginatedTableReportWidget(this.reportModel,
  ...
  @override
  _PaginatedTableReportWidgetState createState() =>
      _PaginatedTableReportWidgetState<K>();
}

class _PaginatedTableReportWidgetState<K>
    extends State<PaginatedTableReportWidget> {
  ReportModel<K>? _reportModel;

  @override
  Widget build(BuildContext context) {
    _reportModel = (widget as PaginatedTableReportWidget<K>).reportModel;
    return SafeArea(
      child: ListView(
        children: <Widget>[
