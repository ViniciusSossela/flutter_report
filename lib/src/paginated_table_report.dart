...
class _PaginatedTableReportState<K> extends State<PaginatedTableReport> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: widget.appBarColors ?? Colors.white,
        elevation: 0,
      ...
      body: SafeArea(
        child: ListView(
          children: <Widget>[
            ...
            if (widget.widgetBetweenButtonDate != null)
              widget.widgetBetweenButtonDate!,
            _reportDataTable(),
          ],
        ),
      ),
